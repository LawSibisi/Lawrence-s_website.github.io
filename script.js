...
function sendMessage(event) {
    ...
    if (message) {
        ...
        if (message.toLowerCase().includes("about")) {
            response = `I'm Lawrence Sibisi, a passionate Junior DevOps Engineer and aspiring software developer with holding a Diplom in Information Technology. If you can learn more about Lawrence <a href="about.html">here</a>.`;
